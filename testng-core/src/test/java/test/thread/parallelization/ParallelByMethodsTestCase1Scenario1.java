 ...
 * equal to the number of test methods, ensuring that no method should have to wait for any other
 * method to complete execution 3) There are NO configuration methods 4) All test methods pass 5) NO
 * ordering is specified 6) group-by-instances is NOT set 7) There are no method exclusions
 */
public class ParallelByMethodsTestCase1Scenario1 extends BaseParallelizationTest {
  private static final Logger log = Logger.getLogger(ParallelByMethodsTestCase1Scenario1.class);
  ...
  public void setUp() {
    ...
    log.debug(
        "Beginning ParallelByMethodsTestCase1Scenario1. This test scenario consists of a "
  ...
  public void verifyOnlyOneInstanceOfTestClassForAllTestMethods() {
    ...
    verifyNumberOfInstancesOfTestClassForMethods(
        SUITE, TEST, TestClassAFiveMethodsWithNoDepsSample.class, 1);
