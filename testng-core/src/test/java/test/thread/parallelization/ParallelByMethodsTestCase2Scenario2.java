 ...
 *
 * <p>Test Case Summary: Parallel by methods mode with parallel test suites, no dependencies and no
 * factories or data providers.
 *
 ...
 * in that suite should have to wait for any other method to complete execution 7) There are NO
 * configuration methods 8) All test methods pass 9) NO ordering is specified 10) group-by-instances
 * is NOT set 11) There are no method exclusions
 */
public class ParallelByMethodsTestCase2Scenario2 extends BaseParallelizationTest {
  private static final Logger log = Logger.getLogger(ParallelByMethodsTestCase2Scenario2.class);
  ...
  public void setUp() {
    ...
    log.debug(
        "Beginning ParallelByMethodsTestCase2Scenario2. This test scenario consists of three "
