...
public class EfficientPriorityParallelizationTest extends BaseParallelizationTest {
  ...
  public void setUp() {
    ...
    suiteOneTestTwoTestMethodLevelEventLogs =
        getTestMethodLevelEventLogsForTest(SUITE_A, SUITE_A_TEST_B);
    ...
    suiteOneTestTwoListenerOnFinishEventLog =
        getTestListenerFinishEventLog(SUITE_A, SUITE_A_TEST_B);
  }
  ...
  public void verifyOnlyOneInstanceOfTestClassForAllTestMethodsForAllSuites() {
    ...
    verifyNumberOfInstancesOfTestClassForMethods(
        SUITE_A, SUITE_A_TEST_B, LowPriorityTestSample.class, 1);

    verifySameInstancesOfTestClassAssociatedWithMethods(
        SUITE_A, SUITE_A_TEST_B, LowPriorityTestSample.class);
  }
  ...
  public void
    ...
    verifyEventsOccurBetween(
        suiteOneTestTwoListenerOnStartEventLog,
        suiteOneTestTwoTestMethodLevelEventLogs,
        suiteOneTestTwoListenerOnFinishEventLog,
        "All of the test method level event logs for "
            + SUITE_A_TEST_B
  ...
  public void verifyThatMethodLevelEventsRunInDifferentThreadsFromSuiteAndTestLevelEvents() {
    ...
    verifyEventsForTestMethodsRunInTheSameThread(
        LowPriorityTestSample.class, SUITE_A, SUITE_A_TEST_B);
  }
